...
const mars_coop = {
  solution: 'https://youtu.be/yR6TD4tAoUk?t=664',
  /**
   * love the design, feeder, waterer and most of things
   */
  /**
   * - features
   *   - sth small and movable https://www.youtube.com/watch?v=rNY8iIV8zKk
   *     - with a closed run that allow chickens to stay out at night for summers
   *   - https://youtu.be/yR6TD4tAoUk?t=664
   *     - use vinyl for floor
   * - todo:
